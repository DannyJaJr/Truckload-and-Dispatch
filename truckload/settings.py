"""
Django settings for truckload project.
...
SECRET_KEY = 'django-insecure-uf=upeb!np@b5v$g^9+av3k*@sl9-*k^z^@^m(zcykg66#6ihc'
...
WSGI_APPLICATION = 'truckload.wsgi.application'
